(function () {
    ...
    const pageText = {
        ...
        de: {
            ...
            strings: {
                ...
                'Available for iOS and Android. Create a group, invite friends, vote on dates and places, and keep the habit going.': 'Verfügbar für iOS und Android. Erstelle eine Gruppe, lade Freunde ein, stimmt über Termine und Orte ab und haltet eure Treffen am Laufen.',
                ...
                'Join restaurants and bars welcoming Stammtisch groups. Our platform can help recurring groups discover your venue, attract new customers during slower periods, and build a loyal community—all while getting free promotion in our app.': 'Schließen Sie sich Restaurants und Bars an, die Stammtisch-Gruppen willkommen heißen. Unsere Plattform kann wiederkehrenden Gruppen helfen, Ihr Lokal zu entdecken, in ruhigeren Zeiten neue Gäste anzuziehen und eine treue Community aufzubauen - inklusive kostenloser Präsenz in unserer App.',
                ...
                'Stammtisch groups typically meet bi-weekly, monthly, or quarterly, which may help you plan for recurring visits.': 'Stammtisch-Gruppen treffen sich typischerweise zweiwöchentlich, monatlich oder vierteljährlich. Das kann bei der Planung wiederkehrender Besuche helfen.',
                ...
                'Fill out the form below with your détails and availability': 'Füllen Sie das Formular unten mit Details und Verfügbarkeiten aus',
                'Get Listed': 'Gelistet werden',
                'We add your location to the app with photos and détails': 'Wir nehmen Ihren Ort mit Fotos und Details in die App auf',
                'Welcome Groups': 'Gruppen empfangen',
                'Groups discover your venue in the app and coordinate visits directly': 'Gruppen entdecken Ihr Lokal in der App und koordinieren Besuche direkt',
            ...
            placeholders: {
                ...
                'drjmudev@gmail.com': 'drjmudev@gmail.com',
        ...
        es: {
            title: {
                ...
                privacy: 'Política de privacidad - Stammtisch',
                terms: 'Términos de servicio - Stammtisch',
                join: 'Unirse a Stammtisch'
            },
            metaDescription: {
                home: 'Stammtisch.pro - Deja atrás los chats de grupo interminables. Encuentra automáticamente el mejor día, hora y lugar para tu próxima reunión. Disponible en iOS y Android.',
                locations: 'Asóciate con Stammtisch para llevar grupos habituales a tu restaurante o bar. Aumenta el tráfico entre semana y crea clientes fieles.',
                privacy: 'Política de privacidad de Stammtisch, incluida la forma en que recopilamos, usamos, protegemos y conservamos información personal.',
                terms: 'Términos de servicio de Stammtisch, incluidas responsabilidades del usuario, limitaciones del servicio, condiciones para locales e información de contacto.',
                join: 'Únete a un grupo de Stammtisch desde tu enlace de invitación.'
            },
            strings: {
                ...
                'Your group chat is full of plans that never happen.': 'Tu chat de grupo está lleno de planes que nunca ocurren.',
                '"Does Friday work?"': '"¿El viernes va bien?"',
                '"I can\'t."': '"No puedo."',
                '"What about next week?"': '"¿Y la semana que viene?"',
                '"Where do we meet again?"': '"¿Dónde quedamos otra vez?"',
                '…and suddenly it\'s been 3 months since you last met.': '...y de repente han pasado 3 meses desde la última vez.',
                'Stammtisch fixes this — your group votes, the best option wins, and the plan is locked in.': 'Stammtisch lo soluciona: tu grupo vota, gana la mejor opción y el plan queda confirmado.',
                'Groups that use Stammtisch don\'t just plan more — they actually meet.': 'Los grupos que usan Stammtisch no solo planean más: se reúnen de verdad.',
                ...
                'Plan locked automatically': 'Plan confirmado automáticamente',
                'Available for iOS and Android. Create a group, invite friends, vote on dates and places, and keep the habit going.': 'Disponible para iOS y Android. Crea un grupo, invita a amigos, voten fechas y lugares, y mantengan el hábito vivo.',
                'No More Scheduling Chaos': 'Se acabó el caos para coordinar',
                'Propose dates and locations, vote with one tap. No more "does Tuesday work?" texts.': 'Propón fechas y lugares, vota con un toque. No más mensajes de "¿el martes va bien?".',
                'The Best Spot, Decided Together': 'El mejor lugar, decidido juntos',
                'Members suggest and vote on locations. The winner is announced automatically.': 'Los miembros proponen y votan lugares. El ganador se anuncia automáticamente.',
                'Everyone Stays in the Loop': 'Todos están al tanto',
                'Calendar invites, email reminders, and notifications. No one misses the next one.': 'Invitaciones de calendario, recordatorios por correo y notificaciones. Nadie se pierde la próxima.',
                'Democratic Voting': 'Votación democrática',
                ...
                'Weekly, biweekly, or monthly — set your cadence and Stammtisch keeps the rhythm going automatically.': 'Semanal, quincenal o mensual: define el ritmo y Stammtisch lo mantiene automáticamente.',
                ...
                'Start free. Upgrade when you\'re ready.': 'Empieza gratis. Mejora cuando estés listo.',
                'Standard': 'Estándar',
                'Free': 'Gratis',
                '1 stammtisch': '1 stammtisch',
                'Up to 5 members': 'Hasta 5 miembros',
                'Date/location voting': 'Votación de fecha/lugar',
                ...
                'Questions or feedback? Send us a message!': '¿Preguntas o comentarios? Envíanos un mensaje.',
                'Send': 'Enviar',
                'Submitting...': 'Enviando...',
                'Sent!': 'Enviado.',
                '✅ Thanks! We\'ll be in touch soon.': 'Gracias. Nos pondremos en contacto pronto.',
                '⚠️ Oops! Something went wrong. Please try again.': 'Vaya, algo salió mal. Inténtalo de nuevo.',
                'Own a Restaurant or Bar?': '¿Tienes un restaurante o bar?',
                'Partner with Stammtisch to connect with groups looking for venues. Help attract customers during slower periods and build community connections.': 'Asóciate con Stammtisch para conectar con grupos que buscan locales. Ayuda a atraer clientes en horas más tranquilas y crea comunidad.',
                '🍺 Learn About Partner Program': 'Ver programa de socios',
                'Terms of Service': 'Términos de servicio',
                'Privacy Policy': 'Política de privacidad',
                'By using Stammtisch, you agree to our Terms of Service. Users attend gatherings at their own risk.': 'Al usar Stammtisch, aceptas nuestros Términos de servicio. Los usuarios asisten a reuniones bajo su propia responsabilidad.',
                'Home': 'Inicio',
                'For Venues': 'Para locales',
                'Privacy': 'Privacidad',
                '🍺 Partner Program': 'Programa de socios',
                'Help Fill Empty Tables With Regular Customers': 'Ayuda a llenar mesas vacías con clientes habituales',
                'Join restaurants and bars welcoming Stammtisch groups. Our platform can help recurring groups discover your venue, attract new customers during slower periods, and build a loyal community—all while getting free promotion in our app.': 'Únete a restaurantes y bares que reciben grupos de Stammtisch. Nuestra plataforma puede ayudar a grupos recurrentes a descubrir tu local, atraer clientes en períodos tranquilos y crear una comunidad fiel, con promoción gratuita en la app.',
                'Potential weekly visits per group*': 'Visitas semanales potenciales por grupo*',
                'Typical people per gathering*': 'Personas típicas por reunión*',
                'Free to join': 'Gratis para unirse',
                '*Results may vary. No guarantees of specific outcomes.': '*Los resultados pueden variar. No se garantizan resultados específicos.',
                'Why Partner With Stammtisch?': '¿Por qué asociarte con Stammtisch?',
                'More Predictable Bookings': 'Reservas más predecibles',
                'Stammtisch groups typically meet bi-weekly, monthly, or quarterly, which may help you plan for recurring visits.': 'Los grupos de Stammtisch suelen reunirse cada dos semanas, mensualmente o trimestralmente, lo que puede ayudarte a planificar visitas recurrentes.',
                'Attract New Customers': 'Atrae nuevos clientes',
                'Each group can bring 4-15 people who may not have visited before. Great experiences can turn first-time guests into regulars.': 'Cada grupo puede traer entre 4 y 15 personas que quizá no te conocían. Una gran experiencia puede convertirlas en clientes habituales.',
                'Free App Promotion': 'Promoción gratis en la app',
                'Your venue can be featured in the Stammtisch app with photos, menu highlights, and directions—reaching local users at no cost.': 'Tu local puede aparecer en la app de Stammtisch con fotos, destacados del menú e indicaciones, llegando a usuarios locales sin coste.',
                'Target Slower Periods': 'Aprovecha períodos tranquilos',
                'Many groups prefer Monday-Thursday evenings. This can help you attract customers during traditionally quieter times.': 'Muchos grupos prefieren las noches de lunes a jueves. Esto puede ayudarte a atraer clientes en horarios tradicionalmente más tranquilos.',
                'Build Community': 'Crea comunidad',
                'Become a gathering spot for local communities. Groups that enjoy your venue may return regularly and recommend you to others.': 'Conviértete en punto de encuentro para comunidades locales. Los grupos que disfruten tu local pueden volver y recomendarte.',
                ...
                'Submit Your Venue': 'Envía tu local',
                'Fill out the form below with your détails and availability': 'Completa el formulario con tus datos y disponibilidad',
                'Get Listed': 'Aparece en la app',
                'We add your location to the app with photos and détails': 'Añadimos tu local a la app con fotos y detalles',
                'Welcome Groups': 'Recibe grupos',
                'Groups discover your venue in the app and coordinate visits directly': 'Los grupos descubren tu local en la app y coordinan visitas directamente',
                ...
                'Become a Partner Venue': 'Conviértete en local asociado',
                'Submit your restaurant or bar to start hosting Stammtisch groups': 'Envía tu restaurante o bar para empezar a recibir grupos de Stammtisch',
                ...
                'Submit Partnership Request': 'Enviar solicitud de asociación',
                'Submitted Successfully!': 'Enviado correctamente.',
                '✅ Thank you! We\'ll review your submission and contact you within 2-3 business days.': 'Gracias. Revisaremos tu solicitud y te contactaremos en 2-3 días laborables.',
                '⚠️ Something went wrong. Please try again or email us directly.': 'Algo salió mal. Inténtalo de nuevo o escríbenos directamente.',
                'Results and outcomes may vary by venue. Stammtisch provides a platform to connect venues with groups but does not guarantee specific business results, customer volume, or revenue increases.': 'Los resultados pueden variar según el local. Stammtisch ofrece una plataforma para conectar locales con grupos, pero no garantiza resultados comerciales, volumen de clientes ni aumentos de ingresos.',
                '← Back to Home': '← Volver al inicio',
                'Back to Home': 'Volver al inicio',
                'Last Updated: March 2, 2026': 'Última actualización: 2 de marzo de 2026',
                ...
                'Information Sharing and Disclosure': 'Compartición y divulgación de información',
                ...
                'Updates to This Policy': 'Actualizaciones de esta política',
        ...
        fr: {
            title: {
                ...
                privacy: 'Politique de confidentialité - Stammtisch',
            ...
            metaDescription: {
                ...
                locations: 'Devenez partenaire de Stammtisch pour accueillir des groupes réguliers dans votre restaurant ou bar. Augmentez la fréquentation en semaine et fidélisez vos clients.',
                privacy: 'Politique de confidentialité de Stammtisch, notamment la collecte, l’utilisation, la protection et la conservation des informations personnelles.',
                terms: 'Conditions d’utilisation de Stammtisch, notamment les responsabilités des utilisateurs, les limites du service, les conditions pour les lieux et les coordonnées.',
            ...
            strings: {
                ...
                'Your group chat is full of plans that never happen.': 'Votre discussion de groupe est pleine de projets qui ne se concrétisent jamais.',
                '"Does Friday work?"': '"Vendredi, ça marche ?"',
                '"I can\'t."': '"Je ne peux pas."',
                '"What about next week?"': '"Et la semaine prochaine ?"',
                '"Where do we meet again?"': '"On se retrouve où déjà ?"',
                '…and suddenly it\'s been 3 months since you last met.': '...et soudain, trois mois ont passé depuis votre dernière rencontre.',
                'Stammtisch fixes this — your group votes, the best option wins, and the plan is locked in.': 'Stammtisch règle ça : votre groupe vote, la meilleure option gagne et le plan est confirmé.',
                ...
                'Create your group': 'Créez votre groupe',
                ...
                'Plan locked automatically': 'Plan confirmé automatiquement',
                'Available for iOS and Android. Create a group, invite friends, vote on dates and places, and keep the habit going.': 'Disponible sur iOS et Android. Créez un groupe, invitez vos amis, votez pour les dates et les lieux, et gardez le rythme.',
                'No More Scheduling Chaos': 'Fini le chaos des agendas',
                'Propose dates and locations, vote with one tap. No more "does Tuesday work?" texts.': 'Proposez des dates et des lieux, votez en un geste. Fini les messages "mardi, ça marche ?".',
                'The Best Spot, Decided Together': 'Le meilleur lieu, choisi ensemble',
                'Members suggest and vote on locations. The winner is announced automatically.': 'Les membres proposent et votent pour les lieux. Le gagnant est annoncé automatiquement.',
                'Everyone Stays in the Loop': 'Tout le monde reste informé',
                ...
                'Democratic Voting': 'Vote démocratique',
                'Every member gets a voice. Propose and vote on dates and locations — the group decides, not one person.': 'Chaque membre a voix au chapitre. Proposez et votez pour les dates et lieux : le groupe décide, pas une seule personne.',
                'Recurring Made Easy': 'Les rencontres régulières simplifiées',
                'Weekly, biweekly, or monthly — set your cadence and Stammtisch keeps the rhythm going automatically.': 'Hebdomadaire, toutes les deux semaines ou mensuel : définissez votre rythme et Stammtisch le maintient automatiquement.',
                'Discover Nearby Groups': 'Découvrez les groupes proches',
                'Browse the map to find open stammtische near you and request to join with one tap.': 'Parcourez la carte pour trouver des stammtische ouverts près de vous et demander à les rejoindre en un geste.',
                'Simple Pricing': 'Tarifs simples',
                'Start free. Upgrade when you\'re ready.': 'Commencez gratuitement. Passez à l’offre supérieure quand vous êtes prêt.',
                'Standard': 'Standard',
                'Free': 'Gratuit',
                '1 stammtisch': '1 stammtisch',
                'Up to 5 members': 'Jusqu’à 5 membres',
                ...
                'Up to 10 stammtische': 'Jusqu’à 10 stammtische',
                'Up to 50 members': 'Jusqu’à 50 membres',
                'Ad-free experience': 'Expérience sans publicité',
                'Analytics dashboard': 'Tableau de bord analytique',
                'Custom branding/themes': 'Marque/thèmes personnalisés',
                ...
                '⚠️ Oops! Something went wrong. Please try again.': 'Oups, une erreur est survenue. Veuillez réessayer.',
                'Own a Restaurant or Bar?': 'Vous possédez un restaurant ou un bar ?',
                'Partner with Stammtisch to connect with groups looking for venues. Help attract customers during slower periods and build community connections.': 'Devenez partenaire de Stammtisch pour entrer en contact avec des groupes à la recherche de lieux. Attirez des clients pendant les périodes plus calmes et créez du lien local.',
                '🍺 Learn About Partner Program': 'Découvrir le programme partenaire',
                'Terms of Service': 'Conditions d’utilisation',
                'Privacy Policy': 'Politique de confidentialité',
                'By using Stammtisch, you agree to our Terms of Service. Users attend gatherings at their own risk.': 'En utilisant Stammtisch, vous acceptez nos Conditions d’utilisation. Les utilisateurs participent aux rencontres à leurs propres risques.',
                'Home': 'Accueil',
                'For Venues': 'Pour les lieux',
                'Privacy': 'Confidentialité',
                '🍺 Partner Program': 'Programme partenaire',
                'Help Fill Empty Tables With Regular Customers': 'Aidez à remplir les tables vides avec des clients réguliers',
                'Join restaurants and bars welcoming Stammtisch groups. Our platform can help recurring groups discover your venue, attract new customers during slower periods, and build a loyal community—all while getting free promotion in our app.': 'Rejoignez les restaurants et bars qui accueillent des groupes Stammtisch. Notre plateforme peut aider des groupes réguliers à découvrir votre lieu, attirer de nouveaux clients pendant les périodes calmes et fidéliser une communauté, avec une promotion gratuite dans l’app.',
                ...
                '*Results may vary. No guarantees of specific outcomes.': '*Les résultats peuvent varier. Aucun résultat spécifique n’est garanti.',
                'Why Partner With Stammtisch?': 'Pourquoi devenir partenaire de Stammtisch ?',
                'More Predictable Bookings': 'Réservations plus prévisibles',
                'Stammtisch groups typically meet bi-weekly, monthly, or quarterly, which may help you plan for recurring visits.': 'Les groupes Stammtisch se réunissent souvent toutes les deux semaines, chaque mois ou chaque trimestre, ce qui peut aider à planifier des visites récurrentes.',
                'Attract New Customers': 'Attirer de nouveaux clients',
                'Each group can bring 4-15 people who may not have visited before. Great experiences can turn first-time guests into regulars.': 'Chaque groupe peut amener 4 à 15 personnes qui ne vous connaissaient peut-être pas. Une belle expérience peut transformer de nouveaux venus en habitués.',
                'Free App Promotion': 'Promotion gratuite dans l’app',
                'Your venue can be featured in the Stammtisch app with photos, menu highlights, and directions—reaching local users at no cost.': 'Votre lieu peut être présenté dans l’app Stammtisch avec photos, points forts du menu et itinéraire, sans frais.',
                'Target Slower Periods': 'Cibler les périodes calmes',
                'Many groups prefer Monday-Thursday evenings. This can help you attract customers during traditionally quieter times.': 'Beaucoup de groupes préfèrent les soirées du lundi au jeudi. Cela peut vous aider a attirer des clients pendant les moments habituellement plus calmes.',
                'Build Community': 'Construire une communauté',
                'Become a gathering spot for local communities. Groups that enjoy your venue may return regularly and recommend you to others.': 'Devenez un point de rencontre pour les communautés locales. Les groupes qui apprécient votre lieu peuvent revenir régulièrement et vous recommander.',
                ...
                'Fill out the form below with your détails and availability': 'Remplissez le formulaire avec vos informations et disponibilités',
                'Get Listed': 'Soyez référencé',
                'We add your location to the app with photos and détails': 'Nous ajoutons votre lieu dans l’app avec photos et détails',
                'Welcome Groups': 'Accueillez les groupes',
                'Groups discover your venue in the app and coordinate visits directly': 'Les groupes découvrent votre lieu dans l’app et coordonnent leurs visites directement',
                'Grow Together': 'Grandir ensemble',
                'Build relationships and watch your regulars multiply': 'Créez des relations et voyez vos habitués se multiplier',
                'Become a Partner Venue': 'Devenir lieu partenaire',
                'Submit your restaurant or bar to start hosting Stammtisch groups': 'Soumettez votre restaurant ou bar pour commencer à accueillir des groupes Stammtisch',
                ...
                'Special Offer for First Groups': 'Offre spéciale pour les premiers groupes',
                'Number of Groups for Special Offer': 'Nombre de groupes pour l’offre',
                'Preferred Days & Times': 'Jours et horaires préférés',
                ...
                '✅ Thank you! We\'ll review your submission and contact you within 2-3 business days.': 'Merci. Nous examinerons votre demande et vous contacterons sous 2 à 3 jours ouvrables.',
                '⚠️ Something went wrong. Please try again or email us directly.': 'Une erreur est survenue. Veuillez réessayer ou nous envoyer un e-mail directement.',
                'Results and outcomes may vary by venue. Stammtisch provides a platform to connect venues with groups but does not guarantee specific business results, customer volume, or revenue increases.': 'Les résultats peuvent varier selon le lieu. Stammtisch fournit une plateforme reliant les lieux aux groupes, mais ne garantit aucun résultat commercial, volume de clients ou hausse de revenus spécifique.',
                '← Back to Home': '← Retour à l’accueil',
                'Back to Home': 'Retour à l’accueil',
                'Last Updated: March 2, 2026': 'Dernière mise à jour : 2 mars 2026',
                ...
                'California Privacy Rights (CCPA)': 'Droits de confidentialité en Californie (CCPA)',
                'Updates to This Policy': 'Mises à jour de cette politique',
    ...
    const legalSummary = {
        ...
        es: 'Nota: Esta página se ha localizado para el sitio web. Para interpretaciones legales, la versión en inglés prevalece salvo que se publique una traducción revisada.',
        fr: 'Remarque : cette page a été localisée pour le site web. Pour toute interprétation juridique, la version anglaise prévaut sauf publication d’une traduction révisée.'
    };
    ...
    const legalHighlights = {
        privacy: {
            de: {
                title: 'Kurzüberblick',
                items: [
                    'Wir erfassen Konto-, Profil-, Gruppen-, Abstimmungs-, RSVP-, Foto-, Kommunikations-, Nutzungs- und Geräteinformationen, soweit sie für den Dienst erforderlich sind.',
            ...
            es: {
                title: 'Resumen',
                items: [
                    'Recopilamos información de cuenta, perfil, grupos, votos, RSVP, fotos, comunicaciones, uso y dispositivo cuando es necesaria para prestar el servicio.',
                    'Usamos datos para prestar y mejorar el servicio, mantener la seguridad y, con consentimiento, enviar novedades del producto.',
                    'No vendemos datos personales y solo compartimos información con miembros del grupo, proveedores de servicio o cuando la ley lo exige.',
                    'Puedes solicitar acceso, rectificación, eliminación, portabilidad, limitación u oposición al tratamiento.'
                ]
            },
            fr: {
                title: 'Résumé',
                items: [
                    'Nous collectons les informations de compte, profil, groupe, vote, RSVP, photo, communication, utilisation et appareil lorsqu’elles sont nécessaires au service.',
                    'Nous utilisons les données pour fournir et améliorer le service, assurer la sécurité et, avec consentement, envoyer des actualités produit.',
                    'Nous ne vendons pas les données personnelles et ne les partageons qu’avec les membres du groupe, les prestataires ou lorsque la loi l’exige.',
                    'Vous pouvez demander l’accès, la rectification, l’effacement, la portabilité, la limitation ou l’opposition au traitement.'
                ]
            }
        },
        terms: {
            ...
            es: {
                title: 'Resumen',
                items: [
                    'Al usar Stammtisch, aceptas estos términos y nuestra política de privacidad.',
                    ...
                    'Los locales y reuniones se visitan bajo responsabilidad propia; Stammtisch no garantiza resultados específicos.'
                ]
            },
            fr: {
                title: 'Résumé',
                items: [
                    'En utilisant Stammtisch, vous acceptez ces conditions et notre politique de confidentialité.',
                    'Stammtisch aide les groupes à organiser des rencontres, mais n’organise ni ne contrôle les rencontres elles-mêmes.',
                    'Les utilisateurs sont responsables d’une utilisation conforme à la loi, d’un comportement respectueux et de la sécurité de leur compte.',
                    'Les lieux et rencontres sont fréquentés à vos propres risques ; Stammtisch ne garantit aucun résultat spécifique.'
                ]
            }
        }
    };
