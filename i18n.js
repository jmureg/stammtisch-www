    ...
    const pageText = {
        ...
        es: {
            ...
            strings: {
                ...
                'Android version currently available to whitelisted beta testers. Interested users can request access by submitting their Google Play Store-associated email address below.': 'La versión de Android está disponible actualmente para beta testers autorizados. Los usuarios interesados pueden solicitar acceso enviando abajo el correo asociado a Google Play Store.',
                ...
                'Join restaurants and bars hosting Stammtisch groups. Our platform can help you get more reservations, attract new customers during slower periods, and build a loyal community—all while getting free promotion in our app.': 'Únete a restaurantes y bares que reciben grupos de Stammtisch. Nuestra plataforma puede ayudarte a conseguir más reservas, atraer clientes en períodos tranquilos y crear una comunidad fiel, con promoción gratuita en la app.',
        ...
        fr: {
            ...
            strings: {
                ...
                'Android version currently available to whitelisted beta testers. Interested users can request access by submitting their Google Play Store-associated email address below.': 'La version Android est actuellement disponible pour les bêta-testeurs autorisés. Les personnes intéressées peuvent demander l’accès en indiquant ci-dessous l’adresse e-mail associée à Google Play Store.',
                ...
                'Stammtisch groups typically meet bi-weekly, monthly, or quarterly, which may help you plan for recurring reservations.': 'Les groupes Stammtisch se réunissent souvent toutes les deux semaines, chaque mois ou chaque trimestre, ce qui peut aider à planifier des réservations récurrentes.',
                ...
                'Groups book directly through the app and visit regularly': 'Les groupes réservent via l’app et viennent régulièrement',
    ...
    const legalHighlights = {
        privacy: {
            ...
            es: {
                title: 'Resumen',
                items: [
                    'Recopilamos información de cuenta, perfil, eventos, comunicaciones, uso y dispositivo cuando es necesaria para prestar el servicio.',
            ...
            fr: {
                title: 'Résumé',
                items: [
                    'Nous collectons les informations de compte, profil, événement, communication, utilisation et appareil lorsqu’elles sont nécessaires au service.',
